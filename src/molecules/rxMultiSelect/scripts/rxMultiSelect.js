...
/**
 * @ngdoc directive
 * @name molecules.directive:rxMultiSelect
 * @restrict E
 * @scope
 * @requires molecules.directive:rxSelectOption
 * @description
 * This molecule is a multi-select dropdown with checkboxes for each option.
